...
from trainer.ForecastCONVAeroTrainerClass import ForecastCONVAeroTrainerClass
...
# файл с аэрологией
# aerofile = "BOM00033008-data.txt" # Минск
# aerofile = "RSM00022543-data.txt" # TALAGI Архангельск
# aerofile = "RSM00023415-data.txt" # PECHORA Печора
# aerofile = "RSM00023802-data.txt" # SYKTYVKAR Сыктывкар
# aerofile = "RSM00024959-data.txt" # JAKUTSK Якутск
# aerofile = "RSM00026781-data.txt" # SMOLENSK
# aerofile = "RSM00027199-data.txt" # KIROV
# aerofile = "RSM00027730-data.txt" # RYAZAN
...
for stantion in st_list:
  ...
  # создаем класс
  # 
  trainer = ForecastCONVAeroTrainerClass()
  ...
  trainer.set_stantion( stantion[0] )  \
         ...
         .set_model_name("OYAP_CONVAERO12")    
