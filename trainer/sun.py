...
class Sun:
    def getSunriseTimeDate( self, coords, _date ):
        return self.calcSunTimeDate( coords, True, _date )

    def getSunsetTimeDate( self, coords, _date ):
        return self.calcSunTimeDate( coords, False, _date )
    ...
    def calcSunTimeDate( self, coords, isRiseTime, _date, zenith = 90.8 ):
    ...
    def calcSunTime( self, coords, isRiseTime, zenith = 90.8 ):
        ...
        return calcSunTime(coords, isRiseTime, [day, month, year])
